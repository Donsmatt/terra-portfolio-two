    ...
    <section className="section" id="skills">
      <div className="row">
        ...
        <div className="section__content">
          ...
          <p className="section__text">From research to execution, here's what I bring to the table </p>
        </div>

        <div className="skill">
          <div className="skill__card">
            <div className="skill__card--image-box">
              <img src={RectangleM} alt="icon"  className="img-1"/>
            </div>
          ...
          <div className="skill__card">
            <div>
              <div className="skill__card--image-box">
                <img src={RectangleL} alt="icon"className="img-2"/>
              </div>
            </div>
            <div className="skill__card--text">
              <div>
          ...
          <div className="skill__card">
            <div>
              <div className="skill__card--image-box">
                <img src={RectangleH} alt="icon" className="img-3"/>
              </div>
            </div>
            <div className="skill__card--text">
              <div>
